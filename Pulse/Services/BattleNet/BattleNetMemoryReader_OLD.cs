...
{
    public class BattleNetMemoryReaderService_OLD
    {
        ...
        public static string[] GetFriendBattleTagStrings(IntPtr processHandle)
        {
            int size;
        ...
        public static string GetUserBattleTagString(IntPtr processHandle)
        {
            int size;
