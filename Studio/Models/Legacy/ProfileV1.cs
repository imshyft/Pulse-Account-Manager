...
namespace Studio.Models.Legacy
{
    ...
    {
        public BattleTagV1 Battletag { get; set; }
        ...
        public RankedCareerV1 RankedCareer { get; set; }


    }

    public class BattleTagV1
    {
        ...
        [JsonConstructor]
        public BattleTagV1(string username, string tag)
        {
            Username = username;
            Tag = tag;
        }
        public BattleTagV1(string battletag)
        {
    ...
    public class Statistic
    {
        ...
        public void ScaleToRole(RoleV1 role) =>
    ...
    public abstract class RoleV1 : INotifyPropertyChanged
    {
